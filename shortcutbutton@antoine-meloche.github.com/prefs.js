...
class UserCommandPrefsWidget extends Adw.PreferencesGroup {
  ...
  addNewButton() {
    ...
    let commandsList = settings.get_value("commands").get_strv();
    let iconsList = settings.get_value("icons").get_strv();
    commandsList.push(command);
    iconsList.push(icon);
    settings.set_value("commands", new GLib.Variant("as", commandsList));
    settings.set_value("icons", new GLib.Variant("as", iconsList));
